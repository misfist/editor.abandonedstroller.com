...
if( function_exists( '\acf_add_local_field_group' ) ) {
	...
	\acf_add_local_field_group( array(
		'key' => 'group_header_images',
		'title' => __( 'Site Header Images', 'core-functionality' ),
		'fields' => array(
			array(
			...
			array(
				...
				'label' => __( 'Contact Email', 'core-functionality' ),
				'name' => 'contact_email',
				'type' => 'email',
				'instructions' => '',
				'required' => 0,
				...
				'show_in_graphql' => 1,
				'default_value' => 'pea@patrizialutz.tech',
				'placeholder' => '',
				'prepend' => '@',
				'append' => '',
			),
...
function register_fields_graphql() {
	\register_graphql_field( 'Project', 'company', [
       'type' 			=> 'string',
	...
	\register_graphql_field( 'Project', 'url', [
       'type' 			=> 'string',
	...
	\register_graphql_field( 'Project', 'clients', [
       'type' 			=> 'string',
